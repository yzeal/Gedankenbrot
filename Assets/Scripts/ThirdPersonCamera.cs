...
//		}
	...
	private void CompensateForWalls(Vector3 fromObject, ref Vector3 toTarget)
	{
		...
		{	
			//Enemies should have this scrpit attached, so they don't cause the camera to jump when they approach from behind:
			DontCollideWithCamera dont = wallHit.collider.GetComponent<DontCollideWithCamera>();
